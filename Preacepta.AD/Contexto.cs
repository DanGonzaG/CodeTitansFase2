    ...
    #warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TCasosEtapa>(entity =>
            {
                ...
                entity.Property(e => e.IdEtapaPl).ValueGeneratedNever();
            ...
            {
                entity.Property(e => e.IdEvidencia).ValueGeneratedNever();
            ...
            modelBuilder.Entity<TCasosTipo>(entity =>
            {
                ...
                entity.Property(e => e.IdTipoCaso).ValueGeneratedNever();
            });
            ...
            {
                entity.Property(e => e.IdCiCliente).ValueGeneratedNever();
            ...
            {
                entity.HasKey(e => e.IdDocumento).HasName("PK__T_DocsAu__B79DF3722CA873C0");
            ...
            {
                entity.HasKey(e => e.IdDocumento).HasName("PK__T_DocsCo__B79DF372064987A5");
            ...
            {
                entity.HasKey(e => e.IdDocumento).HasName("PK__T_DocsCo__B79DF372B55D1707");
            ...
            {
                entity.HasKey(e => e.IdDocumento).HasName("PK__T_DocsIn__B79DF372EE85576B");
            ...
            {
                entity.HasKey(e => e.IdDocumento).HasName("PK__T_DocsOp__B79DF3723660FAA0");
            ...
            {
                entity.HasKey(e => e.IdDocumento).HasName("PK__T_DocsPa__B79DF372D40C30BD");
            ...
            modelBuilder.Entity<TGeNegocio>(entity =>
            {
                ...
                entity.Property(e => e.CJuridica).ValueGeneratedNever();
            });
            ...
            {
                entity.Property(e => e.IdTestimonio).ValueGeneratedNever();
