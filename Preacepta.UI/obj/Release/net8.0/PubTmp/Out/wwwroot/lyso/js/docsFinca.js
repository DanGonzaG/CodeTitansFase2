...
document.getElementById('btnPrevisualizar').addEventListener('click', () => {
    ...
    const distritoFinca = document.getElementById('distrito').value;
    const cantonFinca = document.getElementById('canton').value;
    const provinciaFinca = document.getElementById('provincia').value;
