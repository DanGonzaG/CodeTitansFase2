document.addEventListener("DOMContentLoaded", function () {
    fetch("/Ubicacion/Provincias") //llama el controller y metodo en controller usa la equita route al igual que el metodo usa la equite httpsGet
        ...
        .then(data => {
            ...
            const selectProvincia = document.getElementById("provincia2");
            ...
            //Ocultar los nice Select
            //$('#provincia2').niceSelect('update');
            $('#provincia2').next('.nice-select').hide();
            $('#canton2').next('.nice-select').hide();
            $('#distrito2').next('.nice-select').hide();
...
document.getElementById("provincia2").addEventListener("change", function () {
    ...
    const selectCanton = document.getElementById("canton2");
    const inputCanton = document.getElementById('inputCanton2')
...
document.getElementById("canton2").addEventListener("change", function () {
    const idCanton = this.value;
    const selectDistrito = document.getElementById("distrito2");
    const inputDistrito = document.getElementById('inputDistrito2')
